...
const AddCarForm = () => {
  ...
  const onSubmit = async (data) => {
    if (uploadedImages.length === 0) {
      setImageError("Please upload at atleast one image");
      return;
    }
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm text-gray-600">
                        "Drag & Drop or click to upload mutiple images "
                      </p>
        ...
        <TabsContent value="ai" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image of a car and let AI extarct its details{" "}
              </CardDescription>
            </CardHeader>
            <CardContent>
