    ...
    <div className="pt-20 flex flex-col">
      ...
      <section className="dotted-background relative py-16 md:py-28">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="gradient-title text-5xl md:text-8xl mb-4 gradient-title">
              Find your dream car with Vehiql AI
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Advanced AI Car Search and test drive from thousands of Vechicles
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div
                className="bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Book a test drive online in minutes, with flexiable scheduling
                options.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4  gap-4">
            {bodyTypes.map((type) => {
              return (
                ...
                >
                  <div className="overflow-hidden rounded-lg flex jutsify-end h-28 mb-4 relative">
                    <Image
                      src={type.image}
                      alt={type.name}
                      fill
